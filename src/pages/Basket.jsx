...
export const Basket = () => {
    const basketItem = useSelector((state) => state.products.products);

    return (
        <div className="relative overflow-x-auto my-10 w-[50%] m-auto">
            {/* clear all items */}
            <div className="p-3">
                <button className="bg-gray-300 p-1 rounded-md w-[100px] hover:bg-gray-400 hover:text-white">
                    Clear All
                </button>
            </div>
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th
                            scope="col"
                            className="px-6 py-3 rounded-l-lg text-center"
                        >
                            Product name
                        </th>
                        ...
                        <th
                            scope="col"
                            className="px-2 py-3 rounded-r-lg text-center"
                        >
                            Control
                        </th>
                    </tr>
